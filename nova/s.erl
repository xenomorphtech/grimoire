-file("/usr/lib/erlang/lib/parsetools-2.5/include/leexinc.hrl", 0).
...
-file("/usr/lib/erlang/lib/parsetools-2.5/include/leexinc.hrl", 14).
...
yystate(47, [34|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(47, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(6, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(47, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 100, C =< 104 ->
    yystate(18, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(47, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 110, C =< 115 ->
    yystate(18, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(47, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 120, C =< 122 ->
    yystate(18, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(47, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,47};
yystate(46, [95|Ics], Line, Col, Tlen, _, _) ->
    yystate(18, Ics, Line, Col, Tlen+1, 1, Tlen);
...
yystate(45, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(45, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 35 ->
    yystate(45, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(45, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,45};
yystate(44, [111|Ics], Line, Col, Tlen, _, _) ->
...
yystate(44, [C|Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(44, [C|Ics], Line, Col, Tlen, _, _) when C >= 97, C =< 110 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(44, [C|Ics], Line, Col, Tlen, _, _) when C >= 112, C =< 122 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(44, Ics, Line, Col, Tlen, _, _) ->
    {11,Tlen,Ics,Line,Col,44};
yystate(43, Ics, Line, Col, Tlen, _, _) ->
    {15,Tlen,Ics,Line,Col};
yystate(42, [97|Ics], Line, Col, Tlen, _, _) ->
    yystate(38, Ics, Line, Col, Tlen+1, 11, Tlen);
...
yystate(42, Ics, Line, Col, Tlen, _, _) ->
    {11,Tlen,Ics,Line,Col,42};
yystate(41, [34|Ics], Line, Col, Tlen, _, _) ->
    yystate(41, Ics, Line, Col, Tlen+1, 9, Tlen);
yystate(41, [C|Ics], Line, Col, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(45, Ics, Line, Col, Tlen+1, 9, Tlen);
yystate(41, [C|Ics], Line, Col, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(45, Ics, Line, Col, Tlen+1, 9, Tlen);
yystate(41, [C|Ics], Line, Col, Tlen, _, _) when C >= 35 ->
    yystate(45, Ics, Line, Col, Tlen+1, 9, Tlen);
yystate(41, Ics, Line, Col, Tlen, _, _) ->
    {9,Tlen,Ics,Line,Col,41};
...
yystate(40, Ics, Line, Col, Tlen, _, _) ->
    {11,Tlen,Ics,Line,Col,40};
yystate(39, Ics, Line, Col, Tlen, _, _) ->
    {14,Tlen,Ics,Line,Col};
yystate(38, [115|Ics], Line, Col, Tlen, _, _) ->
...
yystate(38, [C|Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(38, [C|Ics], Line, Col, Tlen, _, _) when C >= 97, C =< 114 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(38, [C|Ics], Line, Col, Tlen, _, _) when C >= 116, C =< 122 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(38, Ics, Line, Col, Tlen, _, _) ->
    {11,Tlen,Ics,Line,Col,38};
...
yystate(36, [C|Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(36, [C|Ics], Line, Col, Tlen, _, _) when C >= 97, C =< 108 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(36, [C|Ics], Line, Col, Tlen, _, _) when C >= 110, C =< 122 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(36, Ics, Line, Col, Tlen, _, _) ->
    {11,Tlen,Ics,Line,Col,36};
yystate(35, [104|Ics], Line, Col, Tlen, _, _) ->
    yystate(31, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(35, [95|Ics], Line, Col, Tlen, _, _) ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(35, [C|Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(35, [C|Ics], Line, Col, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(35, [C|Ics], Line, Col, Tlen, _, _) when C >= 105, C =< 122 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(35, Ics, Line, Col, Tlen, _, _) ->
    {11,Tlen,Ics,Line,Col,35};
yystate(34, [101|Ics], Line, Col, Tlen, _, _) ->
    yystate(30, Ics, Line, Col, Tlen+1, 11, Tlen);
...
yystate(32, [95|Ics], Line, Col, Tlen, _, _) ->
    yystate(18, Ics, Line, Col, Tlen+1, 3, Tlen);
...
yystate(32, Ics, Line, Col, Tlen, _, _) ->
    {3,Tlen,Ics,Line,Col,32};
yystate(31, [101|Ics], Line, Col, Tlen, _, _) ->
    yystate(27, Ics, Line, Col, Tlen+1, 11, Tlen);
...
yystate(30, Ics, Line, Col, Tlen, _, _) ->
    {6,Tlen,Ics,Line,Col,30};
yystate(29, Ics, Line, Col, Tlen, _, _) ->
    {23,Tlen,Ics,Line,Col};
yystate(28, [116|Ics], Line, Col, Tlen, _, _) ->
    yystate(32, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(28, [95|Ics], Line, Col, Tlen, _, _) ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(28, [C|Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(28, [C|Ics], Line, Col, Tlen, _, _) when C >= 97, C =< 115 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(28, [C|Ics], Line, Col, Tlen, _, _) when C >= 117, C =< 122 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(28, Ics, Line, Col, Tlen, _, _) ->
    {11,Tlen,Ics,Line,Col,28};
yystate(27, [114|Ics], Line, Col, Tlen, _, _) ->
    yystate(23, Ics, Line, Col, Tlen+1, 11, Tlen);
...
yystate(24, [C|Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(24, [C|Ics], Line, Col, Tlen, _, _) when C >= 97, C =< 100 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(24, [C|Ics], Line, Col, Tlen, _, _) when C >= 102, C =< 122 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(24, Ics, Line, Col, Tlen, _, _) ->
    {11,Tlen,Ics,Line,Col,24};
yystate(23, [101|Ics], Line, Col, Tlen, _, _) ->
    yystate(19, Ics, Line, Col, Tlen+1, 11, Tlen);
...
yystate(17, [62|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(16, [100|Ics], Line, Col, Tlen, _, _) ->
    yystate(20, Ics, Line, Col, Tlen+1, 11, Tlen);
...
yystate(16, Ics, Line, Col, Tlen, _, _) ->
    {11,Tlen,Ics,Line,Col,16};
yystate(15, [122|Ics], Line, Col, Tlen, _, _) ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(15, [121|Ics], Line, Col, Tlen, _, _) ->
    yystate(11, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(15, [104|Ics], Line, Col, Tlen, _, _) ->
    yystate(0, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(15, [95|Ics], Line, Col, Tlen, _, _) ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(15, [C|Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(15, [C|Ics], Line, Col, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(15, [C|Ics], Line, Col, Tlen, _, _) when C >= 105, C =< 120 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(15, Ics, Line, Col, Tlen, _, _) ->
    {11,Tlen,Ics,Line,Col,15};
yystate(14, Ics, Line, Col, Tlen, _, _) ->
    {13,Tlen,Ics,Line,Col};
yystate(13, Ics, Line, Col, Tlen, _, _) ->
    {20,Tlen,Ics,Line,Col};
yystate(12, [111|Ics], Line, Col, Tlen, _, _) ->
    yystate(16, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(12, [95|Ics], Line, Col, Tlen, _, _) ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(12, [C|Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(12, [C|Ics], Line, Col, Tlen, _, _) when C >= 97, C =< 110 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(12, [C|Ics], Line, Col, Tlen, _, _) when C >= 112, C =< 122 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(12, Ics, Line, Col, Tlen, _, _) ->
    {11,Tlen,Ics,Line,Col,12};
yystate(11, [112|Ics], Line, Col, Tlen, _, _) ->
    yystate(7, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(11, [95|Ics], Line, Col, Tlen, _, _) ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(11, [C|Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(11, [C|Ics], Line, Col, Tlen, _, _) when C >= 97, C =< 111 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
yystate(11, [C|Ics], Line, Col, Tlen, _, _) when C >= 113, C =< 122 ->
    yystate(18, Ics, Line, Col, Tlen+1, 11, Tlen);
...
yystate(9, [C|Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(9, Ics, Line, Col, Tlen+1, 10, Tlen);
...
yystate(8, Ics, Line, Col, Tlen, _, _) ->
    {4,Tlen,Ics,Line,Col,8};
yystate(7, [101|Ics], Line, Col, Tlen, _, _) ->
    yystate(3, Ics, Line, Col, Tlen+1, 11, Tlen);
...
yystate(4, [110|Ics], Line, Col, Tlen, _, _) ->
    yystate(8, Ics, Line, Col, Tlen+1, 11, Tlen);
...
yystate(0, [101|Ics], Line, Col, Tlen, _, _) ->
    yystate(4, Ics, Line, Col, Tlen+1, 11, Tlen);
